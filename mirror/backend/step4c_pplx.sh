...
echo ""
echo "=== Wynik w kopii testowej: rozklad zastosowanie (top 40) ==="
sqlite3 data_dryrun_test.db "SELECT zastosowanie, COUNT(*) FROM products GROUP BY zastosowanie ORDER BY COUNT(*) DESC LIMIT 40;"
echo ""
