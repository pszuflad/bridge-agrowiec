...
const bak=`${DB}.bak_full_pre_scalanie_p8_koniec_${ts}`;
...
db.close();
fs.writeFileSync(APP+`/audit_scalanie_p8_koniec_${ts}.json`, JSON.stringify(audit,null,1));
console.log("Zaktualizowano:",touched,"| KI:",updKi,"| nazwa:",updNa,"| audit: audit_scalanie_p8_koniec_"+ts+".json");
console.log("GOTOWE");
