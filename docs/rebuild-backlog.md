...
| **Do nowej wersji?** | ✅ TAK |
| **Iteracja** | część parserowa **→ 13a** (zrobione), migracja historycznych wartości **→ 13c (zrobione)**, FE (kolumna/eksport) **→ 13e**. ⚠ Sprostowanie 43-CHORE-i13b: pole mówiło „→ 13b (BE+migracja) + 13d (FE)" — niezgodne z tabelą mapowania (migracja katunify/konstr → 13c) i z roadmapą (FE = 13e; 13d to Selly). Do 13b nie należy żadna część. |
