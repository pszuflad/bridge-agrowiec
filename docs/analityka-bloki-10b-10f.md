...
**Zakres:** 27 tras `/api/analytics/*`. Zamknięte **dwadzieścia**: blok 10a — pięć
...
`top-zmiany` — §4, ticket `24-FEATURE-analityka-ceny`, zamknięty 2026-09-04).
Ten dokument opisuje **pozostałe 7** (bloki 10e i 10f).
