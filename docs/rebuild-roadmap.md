...
| **Skrypty injection** | `pending-injection.js`, `selly-injection.js`, `freq-injection.js` łatają UI spoza Reacta | wchłonąć natywnie: I7 / I8 / **`freq-injection.js` ✅ wchłonięty w 3f-2 (2026-09-01)**, **`pending-injection.js` ✅ wchłonięty w 7b (2026-09-04)** | 🔨 częściowo — zostaje `selly-injection.js` (I8) |
