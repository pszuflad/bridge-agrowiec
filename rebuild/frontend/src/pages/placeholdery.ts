 ...
 * `/waga-gabarytowa`, blok 10a — `/analityka`, a blok 10f — `/` (Pulpit, ostatni placeholder
 * Iteracji 10); każda z nich ma własny komponent wpięty bezpośrednio w `App.tsx`, więc
 * zdejmowanie placeholderów samo w sobie nie zmienia liczby tras routera.
