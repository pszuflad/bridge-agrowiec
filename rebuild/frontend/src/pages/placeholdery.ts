 ...
 * Iteracja 5 — `/historia`, sesja 4b — `/narzuty`, a Iteracja 9 — `/waga-gabarytowa`;
 * każda z nich ma własny komponent wpięty bezpośrednio w `App.tsx`, więc liczba tras
 * routera nie zmienia się (dalej 12).
